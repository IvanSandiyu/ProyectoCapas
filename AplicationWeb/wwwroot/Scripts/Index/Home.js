        ...
        try {
            ...
            productos.forEach(producto => {
                const row = `
                    ...
                    <td class="px-4 py-3 max-w-[12rem] truncate">${producto.proveedorId}</td>
...
//        const response = await fetch('/Index/GetProductos'); // Ruta del controlador
...
//            const row = `
//                <tr class="border-b dark:border-gray-700">
                    //<th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"> ${product.IdProducto} </th>
                    //<td class="px-4 py-3">${product.Nombre}</td>
                    //<td class="px-4 py-3">${product.ProveedorId}</td>
                    //<td class="px-4 py-3 max-w-[12rem] truncate">${product.CategoriaId}</td>
                    //<td class="px-4 py-3">$1000</td>
...
//    try {
//        const response = await fetch('/Index/GetProductos'); // Ajusta la URL de tu API
//        if (!response.ok) {
...
//    tablaCuerpo.innerHTML = ''; // Limpia los productos existentes antes de renderizar

//    productos.forEach((producto) => {
//        const fila = document.createElement('tr');
//        fila.className = 'border-b dark:border-gray-700';
//        fila.innerHTML = `
//                         <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"> ${productos.IdProducto} </th>
//                    <td class="px-4 py-3">${productos.Nombre}</td>
//                    <td class="px-4 py-3">${productos.ProveedorId}</td>
//                    <td class="px-4 py-3 max-w-[12rem] truncate">${productos.CategoriaId}</td>
//                    <td class="px-4 py-3">$1000</td>
//    `;
...
////// Asignar evento al botón para recargar los productos
